...
1. Run in the sample folder:
    `dotnet run --framework net8.0 --project ToolboxEncrypt.csproj <inputPath> <UserPassword> <OwnerPassword> <outputPath>`

### Visual Studio

1. Install Visual Studio 2022 or later.
2. Double-click `ToolboxEncrypt.csproj`.
3. Compile the project in Visual Studio.
4. Run:
    `ToolboxEncrypt.exe <inputPath> <UserPassword> <OwnerPassword> <outputPath>`
