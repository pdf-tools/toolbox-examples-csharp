 ...
 * File:            Program.cs
 *
 * Usage:           ToolboxEncrypt <inputPath> <UserPassword> <OwnerPassword> <outputPath>
 *                  
 * Title:           Encrypt PDF
 *                  
...
namespace ToolboxEncrypt
{
    class Program
    {
        static void Usage()
        {
            Console.WriteLine("Usage: ToolboxEncrypt <inputPath> <UserPassword> <OwnerPassword> <outputPath>");
        }
