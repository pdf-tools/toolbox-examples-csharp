...
1. Run in the sample folder:
    `dotnet run --framework net8.0 --project ToolboxSplit.csproj <inputPath> <firstPage> <lastPage> <outputPath>`

### Visual Studio

1. Install Visual Studio 2022 or later.
2. Double-click `ToolboxSplit.csproj`.
3. Compile the project in Visual Studio.
4. Run:
    `ToolboxSplit.exe <inputPath> <firstPage> <lastPage> <outputPath>`
