...
1. Run in the sample folder:
    `dotnet run --framework net8.0 --project ToolboxAddMetadata.csproj <inputPath> <outputPath> [<mdatafile>]`

### Visual Studio

1. Install Visual Studio 2022 or later.
2. Double-click `ToolboxAddMetadata.csproj`.
3. Compile the project in Visual Studio.
4. Run:
    `ToolboxAddMetadata.exe <inputPath> <outputPath> [<mdatafile>]`
